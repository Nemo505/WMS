...
<div class="container-fluid">
      ...
      <div class="card card-primary">
        <!-- form start -->
        <form method="POST" id="myForm" action="{{route('adjustments.store')}}">
          @csrf
          <div class="card-body">
                ...
                <div class="col-6">
                  <div class="form-group ">
                    ...
                    <div>
                      ...
                      <select id='warehouse_id' required name="warehouse_id" class="form-control getFromShelfNum">
              ...
              <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="adjustment_no" required class="form-control" id="adjustment_no" placeholder="Enter Adjustment No">
                    </div>
                </div>
...
<script>
  ...
  $('#type_{{$i}}').on('change', function() {
      var type = this.value;
      var balance = $("label[for='qty_{{$i}}']").text().split(" ");
      var input = $("#qty_{{$i}}").val();
      if (type == 'sub') {
