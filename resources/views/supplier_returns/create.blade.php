...
<div class="container-fluid">
      ...
      <div class="card card-primary">
        <!-- form start -->
        <form method="POST" id="myForm" action="{{route('supplier_returns.store')}}">
          @csrf
          <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required id="sup_no" name="sup_no" placeholder="Enter Supplier Return number">
                  </div>
                </div>
                <div class="col-4">
                  <div class="form-group">
                ...
                <div class="col-8 text-end">
                  ...
                  <div class="d-flex align-items-center" >
                    <span class="form-control" id="text_scan" style="border: none; box-shadow: none; display: none; color: #dc3545; font-weight: 500; font-size: 13px">
                      ⚠️ Please enter Warehouse, Shelf No and Supplier before scanning.
                    </span>
