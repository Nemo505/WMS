              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="number" name="phone"  class="form-control" value="{{$customer->phone}}" id="phone" >
                  </div>
                </div>              
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="emergency"  class="form-control" value="{{$customer->emergency}}" id="emergency" placeholder="Enter Emergency Contact">
                  </div>
                </div>
            </div>
            <div class="row">
